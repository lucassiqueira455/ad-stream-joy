...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Analizze — Relatórios de Meta Ads e Google Ads" },
      {
        property: "og:description",
        content:
          "Dashboards multi-cliente com Meta Ads e Google Ads, relatórios em PDF e links públicos.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Analizze — Relatórios de Meta Ads e Google Ads" },
