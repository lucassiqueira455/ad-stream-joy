        ...
        <AreaChart data={data} margin={{ top: 10, right: 10, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="spendFill" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stopColor="oklch(0.78 0.19 155)" stopOpacity={0.35} />
              <stop offset="100%" stopColor="oklch(0.78 0.19 155)" stopOpacity={0} />
            </linearGradient>
          </defs>
          <CartesianGrid stroke="oklch(0.28 0.02 260)" strokeDasharray="3 3" vertical={false} />
          <XAxis
            dataKey="date"
          ...
          />
          <Tooltip
            cursor={{ stroke: "oklch(0.78 0.19 155)", strokeWidth: 1 }}
            contentStyle={{
